 ...
 */
contract SecureVault is AccessControl, ReentrancyGuard, Pausable, ERC20, Ownable {
    ...
    // /**
         ...
         * @dev Security: OnlyOwner modifier
         */
    ...
    /**
         ...
         */
    function vest(address beneficiary, uint256 amount, uint256 duration) public  {
        // Preconditions:
        // Beneficiary valid
        // amount > 0
